...
namespace BrightTray.Win32
{
    public class NativeMethods
    {
        ...
        public static extern IntPtr MonitorFromPoint([In] System.Windows.Point pt, uint dwFlags);
        ...
        [DllImport("dxva2.dll", EntryPoint = "SaveCurrentMonitorSettings", SetLastError = true)]
        [return: MarshalAs(UnmanagedType.Bool)]
